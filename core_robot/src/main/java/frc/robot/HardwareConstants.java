...
public class HardwareConstants
{
    ...
    public static final double TANK_DRIVETRAIN_LEFT_ENCODER_PULSES_PER_REVOLUTION = 360.0;
    public static final double TANK_DRIVETRAIN_LEFT_GEAR_RATIO = 1.0;
    public static final double TANK_DRIVETRAIN_LEFT_WHEEL_DIAMETER = 7.65; // (in inches)
    ...
    public static final double TANK_DRIVETRAIN_RIGHT_ENCODER_PULSES_PER_REVOLUTION = 360.0;
    public static final double TANK_DRIVETRAIN_RIGHT_GEAR_RATIO = 1.0;
    public static final double TANK_DRIVETRAIN_RIGHT_WHEEL_DIAMETER = 7.65; // (in inches)
    ...
    public static final double TANK_DRIVETRAIN_WHEEL_SEPARATION_DISTANCE = 24.0; // (in inches)
