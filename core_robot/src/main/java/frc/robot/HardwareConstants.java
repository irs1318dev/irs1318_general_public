...
public class HardwareConstants
{
    ...
    public static final double DRIVETRAIN_STEER_ENCODER_PULSES_PER_REVOLUTION = 1.0;
    ...
    public static final double DRIVETRAIN_DRIVE_ENCODER_PULSES_PER_REVOLUTION = 1.0;
    ...
    public static final double DRIVETRAIN_DRIVE_MOTOR_VELOCITY_TO_INCHES_PER_SECOND = HardwareConstants.DRIVETRAIN_DRIVE_PULSE_DISTANCE; // converts rotations per second into inches per second.
    public static final double DRIVETRAIN_DRIVE_INCHES_PER_SECOND_TO_MOTOR_VELOCITY = HardwareConstants.DRIVETRAIN_DRIVE_TICKS_PER_INCH; // converts inches per second into rotations per second
