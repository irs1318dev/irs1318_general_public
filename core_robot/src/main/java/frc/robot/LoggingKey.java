...
public enum LoggingKey
{
    ...
    OneMotorSRXVelocity("omsrx/velocity", LoggingType.Number, true),
    OneMotorSRXError("omsrx/error", LoggingType.Number, true),
    OneMotorSRXPosition("omsrx/position", LoggingType.Number, true),
    OneMotorSRXForwardLimit("omsrx/forwardlimit", LoggingType.Number, true),
    OneMotorSRXReverseLimit("omsrx/reverselimit", LoggingType.Number, true),
    OneMotorSRXSetpoint("omsrx/setpoint", LoggingType.Number, false),
    OneMotorSRXErrorPercent("omsrx/error%", LoggingType.Number, false),
    OneMotorSparkVelocity("omspark/velocity", LoggingType.Number, true),
    OneMotorSparkPosition("omspark/position", LoggingType.Number, true),
    OneMotorSparkForwardLimit("omspark/forwardlimit", LoggingType.Number, true),
    OneMotorSparkReverseLimit("omspark/reverselimit", LoggingType.Number, true),
    OneMotorSparkSetpoint("omspark/setpoint", LoggingType.Number, false);
