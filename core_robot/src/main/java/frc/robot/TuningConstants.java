...
public class TuningConstants
{
    ...
    public static final double DRIVETRAIN_STEER_MOTOR1_ABSOLUTE_OFFSET = -34.0;
    public static final double DRIVETRAIN_STEER_MOTOR2_ABSOLUTE_OFFSET = -113.82;
    public static final double DRIVETRAIN_STEER_MOTOR3_ABSOLUTE_OFFSET = 120.94;
    public static final double DRIVETRAIN_STEER_MOTOR4_ABSOLUTE_OFFSET = -72.25;
