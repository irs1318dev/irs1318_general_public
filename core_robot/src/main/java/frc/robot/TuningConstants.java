...
public class TuningConstants
{
    ...
    public static final double DRIVETRAIN_STEER_MOTOR1_ABSOLUTE_OFFSET = -37.7;
    public static final double DRIVETRAIN_STEER_MOTOR2_ABSOLUTE_OFFSET = -123.6;
    public static final double DRIVETRAIN_STEER_MOTOR3_ABSOLUTE_OFFSET = 122.25;
    public static final double DRIVETRAIN_STEER_MOTOR4_ABSOLUTE_OFFSET = 64.33;
    ...
    public static final double DRIVETRAIN_DRIVE_MOTOR_VELOCITY_PID_KS = 88.0; // RPS ~106.0 was highest speed at full throttle FF on blocks

    public static final double DRIVETRAIN_DRIVE_MOTOR1_VELOCITY_PID_KP = 0.02 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR1_VELOCITY_PID_KI = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR1_VELOCITY_PID_KD = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR1_VELOCITY_PID_KF = 0.00961538 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0); // 100% control authority (on blocks)

    public static final double DRIVETRAIN_DRIVE_MOTOR2_VELOCITY_PID_KP = 0.02 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR2_VELOCITY_PID_KI = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR2_VELOCITY_PID_KD = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR2_VELOCITY_PID_KF = 0.00961538 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0); // 100% control authority (on blocks)

    public static final double DRIVETRAIN_DRIVE_MOTOR3_VELOCITY_PID_KP = 0.02 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR3_VELOCITY_PID_KI = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR3_VELOCITY_PID_KD = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR3_VELOCITY_PID_KF = 0.00961538 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0); // 100% control authority (on blocks)

    public static final double DRIVETRAIN_DRIVE_MOTOR4_VELOCITY_PID_KP = 0.02 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR4_VELOCITY_PID_KI = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR4_VELOCITY_PID_KD = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR4_VELOCITY_PID_KF = 0.00961538 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0); // 100% control authority (on blocks)

    public static final double DRIVETRAIN_DRIVE_MOTOR1_POSITION_PID_KP = 2.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR1_POSITION_PID_KI = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR1_POSITION_PID_KD = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR1_POSITION_PID_KF = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);

    public static final double DRIVETRAIN_DRIVE_MOTOR2_POSITION_PID_KP = 2.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR2_POSITION_PID_KI = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR2_POSITION_PID_KD = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR2_POSITION_PID_KF = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);

    public static final double DRIVETRAIN_DRIVE_MOTOR3_POSITION_PID_KP = 2.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR3_POSITION_PID_KI = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR3_POSITION_PID_KD = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR3_POSITION_PID_KF = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);

    public static final double DRIVETRAIN_DRIVE_MOTOR4_POSITION_PID_KP = 2.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR4_POSITION_PID_KI = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR4_POSITION_PID_KD = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
    public static final double DRIVETRAIN_DRIVE_MOTOR4_POSITION_PID_KF = 0.0 * (TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION_ENABLED ? TuningConstants.DRIVETRAIN_DRIVE_VOLTAGE_COMPENSATION : 1.0);
