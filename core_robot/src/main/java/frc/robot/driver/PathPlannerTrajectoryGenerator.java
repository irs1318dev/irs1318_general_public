    ...
    public static void generateTrajectories(TrajectoryManager trajectoryManager, IPathPlanner pathPlanner)
    {
        ...
        addTrajectory(
            ...
            pathPlanner.buildTrajectory(
                TuningConstants.DRIVETRAINNEO_MAX_PATH_TRANSLATIONAL_VELOCITY,
                TuningConstants.DRIVETRAINNEO_MAX_PATH_TRANSLATIONAL_ACCELERATION,
        ...
        addTrajectory(
            trajectoryManager,
            pathPlanner.buildTrajectory(
                TuningConstants.DRIVETRAINNEO_TRUE_MAX_PATH_TRANSLATIONAL_VELOCITY,
                TuningConstants.DRIVETRAINNEO_MAX_PATH_TRANSLATIONAL_ACCELERATION,
                new PathPlannerWaypoint(0.0, 0.0, 180.0, 0.0),
                new PathPlannerWaypoint(-12.0, 0.0, 180.0, 0.0)),
                "goBackwards15in");
        addTrajectory(
            trajectoryManager,
            pathPlanner.buildTrajectory(
                TuningConstants.DRIVETRAINNEO_MID_PATH_TRANSLATIONAL_VELOCITY,
                TuningConstants.DRIVETRAINNEO_MID_PATH_TRANSLATIONAL_ACCELERATION,
