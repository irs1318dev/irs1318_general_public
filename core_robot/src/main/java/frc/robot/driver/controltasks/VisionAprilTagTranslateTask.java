...
public class VisionAprilTagTranslateTask extends ControlTaskBase
{
    ...
    public void begin()
    {
        ...
        this.setDigitalOperationState(DigitalOperation.VisionFindSpecificAprilTagRear, false);
        this.setDigitalOperationState(DigitalOperation.VisionFindSpecificAprilTagFront, false);
