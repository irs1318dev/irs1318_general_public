...
public class PowerCellMechanism implements IMechanism
{
    ...
    public PowerCellMechanism(IDriver driver, LoggingManager logger, ITimer timer, IRobotProvider provider)
    {
        ...
        this.flyWheel.setMotorOutputSettings(HardwareConstants.POWERCELL_FLYWHEEL_MASTER_INVERT_OUTPUT, MotorNeutralMode.Coast);
        ...
        flyWheelFollower.setMotorOutputSettings(HardwareConstants.POWERCELL_FLYWHEEL_FOLLOWER_INVERT_OUTPUT, MotorNeutralMode.Coast);
        ...
        this.carouselMotor.setMotorOutputSettings(HardwareConstants.POWERCELL_CAROUSEL_MOTOR_INVERT_OUTPUT, MotorNeutralMode.Brake);
