...
public class RobotSimulator implements IRealWorldSimulator
{
    ...
    private static final FauxbotSensorConnection AngleEncoder1Connection = new FauxbotSensorConnection(FauxbotSensorConnection.SensorConnector.CAN, FauxbotTalonFX.class, 1);
    private static final FauxbotSensorConnection DriveEncoder1Connection = new FauxbotSensorConnection(FauxbotSensorConnection.SensorConnector.CAN, FauxbotTalonFX.class, 2);
    ...
    private static final FauxbotSensorConnection AngleEncoder2Connection = new FauxbotSensorConnection(FauxbotSensorConnection.SensorConnector.CAN, FauxbotTalonFX.class, 3);
    private static final FauxbotSensorConnection DriveEncoder2Connection = new FauxbotSensorConnection(FauxbotSensorConnection.SensorConnector.CAN, FauxbotTalonFX.class, 4);
    ...
    private static final FauxbotSensorConnection AngleEncoder3Connection = new FauxbotSensorConnection(FauxbotSensorConnection.SensorConnector.CAN, FauxbotTalonFX.class, 5);
    private static final FauxbotSensorConnection DriveEncoder3Connection = new FauxbotSensorConnection(FauxbotSensorConnection.SensorConnector.CAN, FauxbotTalonFX.class, 6);
    ...
    private static final FauxbotSensorConnection AngleEncoder4Connection = new FauxbotSensorConnection(FauxbotSensorConnection.SensorConnector.CAN, FauxbotTalonFX.class, 7);
    private static final FauxbotSensorConnection DriveEncoder4Connection = new FauxbotSensorConnection(FauxbotSensorConnection.SensorConnector.CAN, FauxbotTalonFX.class, 8);
